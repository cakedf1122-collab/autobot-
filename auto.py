...
TANGGAL_EXPIRED = datetime(2026, 5, 26, 23, 59, 59).replace(tzinfo=None)
# Kita buat versi sadar zona waktu untuk perbandingan real-time
if hasattr(local_tz, 'localize'):
    TANGGAL_EXPIRED_TZ = local_tz.localize(datetime(2026, 5, 26, 23, 59, 59))
else:
    TANGGAL_EXPIRED_TZ = datetime(2026, 5, 26, 23, 59, 59, tzinfo=local_tz)
